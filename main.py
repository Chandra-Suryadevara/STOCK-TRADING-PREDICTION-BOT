...
class root(customtkinter.CTk):
 ...
 def predict(self):
  ...
  try:
    ...
    self.label5 = customtkinter.CTkLabel(master = self.frame, text = "Please Enter the Correct Stock Ticker", font=("Roboto" , 20, BOLD))
  ...
  self.label5 = customtkinter.CTkLabel(master = self.frame, text = "Training the prediction on your stock...", font=("Roboto" , 20, BOLD))
  self.label5.pack(pady =30, padx = 10)
  self.update()
 ...
 def visualize(self):
  ...
  try:
    ...
    self.label1 = customtkinter.CTkLabel(master = self.frame, text = "Please predict before visualizing.", font=("Roboto" , 20, BOLD))
    self.label1.pack(pady =30, padx = 10)
    self.update()
    time.sleep(5)
    self.label1.destroy()
